...
//globals
int Return_Val, i = 0, j = 0, k = 0, m = 0, n = 0, Count, New_Count, Temp, Space_Count = 0;
char *Argv[10], *Argv2[10], *Return_Val_2;
char Input_Command[256], Input_Command_Copy[256];
char *Temp_Char, *Temp_Char_1, *Temp_Char_2, *Temp_Char_3, *Temp_Char_4, *Save_Ptr;
...
void Parse_Arguments()
{
	...
	{
		// Temp_Char_4 = strdup(Temp_Char_1);
		// Check_Redirection_Error();
		//printf("redirection operator is found\n");
		Redirection = 1;
