...
def find_match(json_product_1, json_product_2, dict = "color_dict.txt", attr_1 = "Color", attr_2 = "Actual Color"):
     p1_attr_values = []
     p2_attr_values = []
     p1_attr_1_values = []
     p1_attr_2_values = []
     ...
     #return -1 (i dont know) for parse error
     try:
          p1 = json.loads(json_product_1)
          p2 = json.loads(json_product_2)
     except:
          return (-1, 1)
