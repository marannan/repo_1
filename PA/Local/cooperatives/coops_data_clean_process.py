...
def write_to_file(othsal_compens,ass_eoy,totrev):
    ...
    writer = csv.writer(open('data/core_501(c)_others_othsal_compens.csv', 'wb'))
    for key, value in othsal_compens.items():
        writer.writerow([key, value])    
        
    
    writer = csv.writer(open('data/core_501(c)_others_ass_eoy.csv', 'wb'))
    for key, value in ass_eoy.items():
        writer.writerow([key, value])        


    writer = csv.writer(open('data/core_501(c)_others_totrev.csv', 'wb'))
...
def read_from_file():
    reader = csv.reader(open('data/core_501(c)_others_othsal_compens.csv', 'rb'))
    othsal_compens = dict(reader)
    
    reader = csv.reader(open('data/core_501(c)_others_ass_eoy.csv', 'rb'))
    ass_eoy = dict(reader)
    
    reader = csv.reader(open('data/core_501(c)_others_totrev.csv', 'rb'))
    totrev = dict(reader)
