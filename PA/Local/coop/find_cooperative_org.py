...
with open('coopdict.csv', 'wb') as csvfile:
        ...
        csv_writer.writerow(["ORG_NAME","EIN","NTEECC","ACT_CODE", "TITLE WEIGHT","WEIGHT","WEIGHT1","WEIGHT2","PREDICTION","PURPOSE", "SERVICE A", "SERVICE B", "SERVICE C"])
        # for val in maindict:
        #     count = 0
        ...
        for val in maindict:
            ...
            if include_code == 1:
                if (count1 > 2000 or (count1 > 1000 and count1 < 2000)) and titlecount > 0:
                    csv_writer.writerow([val,maindict[val]["ORG_NAME"],maindict[val]["NTEECC"],maindict[val]["ACT_CODE"],titlecount, count,count1,count2,4,maindict[val]["PURPOSE"],maindict[val]["SERVICE A"],maindict[val]["SERVICE B"],maindict[val]["SERVICE C"]])
                elif count2>0 and titlecount > 0:
                    csv_writer.writerow([val,maindict[val]["ORG_NAME"],maindict[val]["NTEECC"],maindict[val]["ACT_CODE"],titlecount, count,count1,count2,3,maindict[val]["PURPOSE"],maindict[val]["SERVICE A"],maindict[val]["SERVICE B"],maindict[val]["SERVICE C"]])
                elif ((count >= 2000 or (count >= 1000 and count < 2000)) or count2>0) and titlecount > 0:
                    csv_writer.writerow([val,maindict[val]["ORG_NAME"],maindict[val]["NTEECC"],maindict[val]["ACT_CODE"],titlecount, count,count1,count2,2,maindict[val]["PURPOSE"],maindict[val]["SERVICE A"],maindict[val]["SERVICE B"],maindict[val]["SERVICE C"]])
                elif (count >= 2000 or (count >= 1000 and count < 2000)) or count2>0 or titlecount > 0:
                    csv_writer.writerow([val,maindict[val]["ORG_NAME"],maindict[val]["NTEECC"],maindict[val]["ACT_CODE"],titlecount, count,count1,count2,1,maindict[val]["PURPOSE"],maindict[val]["SERVICE A"],maindict[val]["SERVICE B"],maindict[val]["SERVICE C"]])
                else:
                    csv_writer.writerow([val,maindict[val]["ORG_NAME"],maindict[val]["NTEECC"],maindict[val]["ACT_CODE"],titlecount, count,count1,count2,0,maindict[val]["PURPOSE"],maindict[val]["SERVICE A"],maindict[val]["SERVICE B"],maindict[val]["SERVICE C"]])
